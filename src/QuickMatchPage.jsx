...
function TopicIcon({ index }) {
  const icons = [
    ...
    <>
      <path d="M4 16c1.4-5.8 7.2-9.4 14-8.6 3.9.5 6 2.2 9.3 1.3 2.4-.7 4.3.7 3.6 3.2-1.5 5.2-7 10.1-14.3 12.4-6.4 2-12.1.5-13.3-3.5-.5-1.7-.3-3.2.4-4.8Z" />
      <path d="M8 18c4 2.4 9 2.2 13-.1 2.8-1.6 5-3.5 9-4.2" />

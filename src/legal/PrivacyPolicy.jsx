...
const cards = [
  ...
  { n: 2, icon: 'database', title: 'Information We Collect', body: <div className="privacy-collect-sections">
    ...
    <section><h4>E. Cookies &amp; Tracking Technologies</h4><p>We use:</p><ul><li>Cookies</li><li>Local storage</li><li>Analytics tools</li></ul><p>These help us improve performance, personalize content, and analyze usage. You can disable cookies in your browser, but some features may not work.</p></section>
  </div> },

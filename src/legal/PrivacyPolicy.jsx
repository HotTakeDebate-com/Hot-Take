...
const cards = [
  ...
  { n: 2, icon: 'database', title: 'Information We Collect', body: <><h4>A. Information You Provide</h4><p>We may collect:</p><ul><li>Name or username</li><li>Email address</li><li>Account credentials</li><li>Profile information</li><li>Content you upload (debates, posts, recordings, messages)</li><li>Communications with us</li></ul><h4>B. Automatically Collected Information</h4><p>We may automatically collect:</p><ul><li>IP address</li><li>Device type and browser</li><li>Operating system</li><li>Usage data (clicks, interactions, time spent)</li><li>Log data (timestamps, pages visited)</li></ul><h4>C. Audio, Video &amp; Debate Content</h4><p>Because Hot Take is a debate platform:</p><ul><li>We collect and store audio, video, and speech data</li><li>This content may be recorded, processed, and analyzed</li></ul><h4>D. AI-Generated &amp; Derived Data</h4><p>We may generate or infer data such as:</p><ul><li>Content moderation signals</li><li>Behavioral insights</li><li>Engagement patterns</li></ul><h4>E. Cookies &amp; Tracking Technologies</h4><p>We use cookies, local storage, and analytics tools to improve performance, personalize content, and analyze usage. You can disable cookies in your browser, but some features may not work.</p></> },
